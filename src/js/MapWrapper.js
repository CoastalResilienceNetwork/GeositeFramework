    ...
    N.createMapWrapper = function (esriMap, mapModel, pluginObject) {
        ...
        function rememberLayer(layer) {
            if (!isMyLayer(layer)) {
                ...
                if (_.contains(["esri.layers.ArcGISDynamicMapServiceLayer", "esri.layers.ArcGISTiledMapServiceLayer", "esri.layers.WMSLayer", "esri.layers.FeatureLayer"], layer.declaredClass)) {
